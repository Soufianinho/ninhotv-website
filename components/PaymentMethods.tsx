      ...
      <div className="container mx-auto px-4 relative z-10">
          ...
          {paymentMethods.map((method, index) => (
            ...
            >
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                onClick={() => window.open('https://wa.me/212644870099?text=Hi! I want to subscribe to NinhoTV using ' + method.name + ' payment method.', '_blank')}
        ...
        >
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            onClick={() => window.open('https://wa.me/212644870099?text=Hi! I need help choosing the best payment method for my NinhoTV subscription.', '_blank')}
